...
const RoleBadge: React.FC<{ role: UserRole }> = ({ role }) => {
  ...
  const roleClasses: Record<string, string> = {
    [UserRole.ADMIN]: 'bg-moon-purple/20 text-moon-purple-light', // ADMIN
    [UserRole.DIRECTOR]: 'bg-moon-orange/20 text-moon-orange',    // DIRECTOR (covers legacy Admin/Director)
    [UserRole.CONTROL_ESTUDIOS]: 'bg-moon-green/20 text-moon-green',
    [UserRole.DOCENTE]: 'bg-moon-blue/20 text-moon-blue',
  };
